  ...
  return (
    <div className="liquid-glass p-5 sm:p-6 md:p-8 mb-8 w-[95%] sm:w-[90%] md:w-full max-w-2xl mx-auto transform transition-all">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        <div className="form-control">
          ...
          <div className="relative mt-1">
            ...
            <input 
              type="text" 
              placeholder="zuck" 
              className="input input-lg w-full pl-10 input-glass transition-all shadow-inner focus:outline-none focus:ring-2 focus:ring-pink-400 font-medium" 
              value={username}
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text font-bold text-gray-200 uppercase tracking-wider text-sm">LỜI CHÚC</span>
          </label>
          <div className="mt-1">
            <input 
              type="text"
              className="input input-lg w-full input-glass transition-all shadow-inner focus:outline-none focus:ring-2 focus:ring-pink-400 font-medium" 
        ...
        <button 
          type="submit" 
          className={`btn btn-lg w-full text-white bg-white/20 hover:bg-white/30 backdrop-blur-md border border-white/30 shadow-[0_4px_15px_rgba(0,0,0,0.2)] rounded-2xl mt-6 uppercase tracking-widest font-bold transition-all ${isSubmitting ? 'loading' : ''}`}
